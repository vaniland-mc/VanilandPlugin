...
const val VANILAND_COMMAND = "$PREFIX.admin.vaniland"

const val NOTIFY_MCBANS_LOOKUP = "$PREFIX.admin.mcbans.notify"
const val MCBANS_IGNORE_COMMAND = "$PREFIX.admin.mcbans.ignore"
